...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"/Users/sahil/Downloads/Attendance_Management_System_Using_Face_Recognition-main/Images_GUI/bgReg.jpg")
        ...
        get_str = Label(frame,text= "Sign Up",font=("times new roman",30,"bold"),fg="#002B53",bg="#F2F2F2")
        get_str.place(x=350,y=100)

        #label1 
        fname =lb1= Label(frame,text="Last Name:",font=("times new roman",15,"bold"),fg="#002B53",bg="#F2F2F2")
        ...
        #label1 
        cnum =lb1= Label(frame,text="Contact:",font=("times new roman",15,"bold"),fg="#002B53",bg="#F2F2F2")
        ...
        # Checkbutton
        checkbtn = Checkbutton(frame,variable=self.var_check,text="Accept the terms and conditions",font=("times new roman",13,"bold"),fg="#002B53",bg="#F2F2F2")
        checkbtn.place(x=100,y=480,width=270)


        # Creating Button Register
        loginbtn=Button(frame,command=self.reg,text="Sign Up",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#002B53",activeforeground="white",activebackground="#007ACC")
    ...
    def reg(self):
        if (self.var_fname.get()=="" or self.var_lname.get()=="" or self.var_cnum.get()=="" or self.var_email.get()=="" or self.var_ssq.get()=="Select" or self.var_sa.get()=="" or self.var_pwd.get()=="" or self.var_cpwd.get()==""):
            ...
            messagebox.showerror("Error","Please make sure the password and confirm password match!")
        elif(self.var_check.get()==0):
            messagebox.showerror("Error","Please ensure you have read and agreed to the Terms and Conditions!")
        else:
